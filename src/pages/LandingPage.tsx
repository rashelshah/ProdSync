...
import { Package, Zap, Shield, BarChart3, ArrowRight, Film } from 'lucide-react';
      ...
      <nav className="p-4 md:p-6 border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white text-black rounded-xl flex items-center justify-center shadow-medium">
              <Film className="w-5 h-5" />
            </div>
            <span className="text-xl font-bold text-foreground">ProdSync</span>
          </div>
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Link to="/producer/register">
              <Button className="bg-white text-black hover:bg-zinc-200 rounded-full font-semibold" size="sm">Get Started</Button>
            </Link>
          </div>
        </div>
      </nav>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Link to="/producer/register">
              <Button asChild size="lg" className="h-12 px-8 bg-white text-black hover:bg-zinc-200 rounded-full text-base font-semibold w-full sm:w-auto">
          ...
          <Card className="shadow-strong bg-gradient-card border-0 p-8">
            <CardContent className="p-0">
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Join thousands of vendors who trust ProdSync to manage their equipment rentals
              </p>
              <Button
                type="submit"
                className="w-full h-12 bg-white text-black hover:bg-zinc-200 rounded-full text-base font-semibold sm:w-auto px-10"
                asChild
              >
                <Link to="/producer/register">Get Started Now</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
      ...
      <footer className="py-8 px-6 border-t border-border bg-card/50">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-muted-foreground">
            © {new Date().getFullYear()} ProdSync. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
