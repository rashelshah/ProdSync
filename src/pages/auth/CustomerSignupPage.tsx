...
import { Camera, Mail, Phone, Film } from 'lucide-react';
...
export const CustomerSignupPage: React.FC = () => {
  ...
  const handleSkipKyc = () => {
    ...
    toast.success('Account created successfully! Welcome to ProdSync.');
    navigate('/customer/dashboard');
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-white text-black rounded-xl flex items-center justify-center shadow-medium">
              <Film className="w-6 h-6" />
            </div>
            <span className="text-2xl font-bold text-foreground">ProdSync</span>
          </div>
        </div>
        ...
        <Card className="shadow-strong bg-gradient-card border-0">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center">
              {step === 'details' 
                ? 'Join ProdSync to rent professional equipment'
                : step === 'otp'
